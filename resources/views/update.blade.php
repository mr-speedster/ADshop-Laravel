...
<form method="POST" enctype="multipart/form-data" action="/update/{{$current->id}}">
    ...
    <div class="input-div one">
        ...
        <div class="div">
            ...
            <input required type="text" value="{{$current->product_name}}" id="user_name" name="product_name" class="input">
        </div>
    </div>
    <div class="input-div one">
        <div class="i">
        ...
        <div class="div">
            ...
            <input required type="number" value="{{$current->price}}" id="user_name" name="product_price" class="input">
        </div>
    </div>
    <div class="mb-3">
        <div class="div">
